...
public record ResponsavelDto(
        @NotNull(message = "UUID de responsável é obrigatório")
        UUID uuid,
        ...
        @Size(min = 8, max = 20, message = "Telefone deve ter entre {min} e {max} caracteres")
        String telefone,

        @NotBlank(message = "Endereço é obrigatório")
        @Size(min = 3, max = 200, message = "Endereço deve ter entre {min} e {max} caracteres")
        String endereco
) { }
